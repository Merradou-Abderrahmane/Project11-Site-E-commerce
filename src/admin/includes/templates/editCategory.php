...
if (isset($_GET['id'])){
    $id = $_GET['id'];
    $ecommerce = $ecommerceManagement->getCategory($id);
}

if(isset($_POST['update'])){
	$fileName = $_FILES["uploadedFile"]["name"];
	$editedCategory = new ECommerce();

	$editedCategory->setCategoryName($_POST['name']);

	
	$editedCategory->editEmployee($editedCategory, $id);
